...
const metricItem = (label: string, value: string) => (
  <div className="flex flex-col gap-1 rounded-xl border border-slate-200/70 bg-white/70 px-4 py-3">
...
export const CourseLearnHeader = ({
  ...
  return (
    <header className={cn("mb-6 w-full") }>
      <div className="rounded-2xl border border-slate-200/80 bg-gradient-to-br from-white to-slate-50 px-5 py-6 sm:px-8">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="min-w-[200px] rounded-xl bg-slate-900 px-5 py-4 text-right text-slate-50">
