...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "p-3",
        // Enforce grid layout on header and day rows even if external styles change table defaults
        "[&_table]:w-full [&_table]:border-collapse [&_.rdp-head_row]:grid [&_.rdp-head_row]:grid-cols-7 [&_.rdp-row]:grid [&_.rdp-row]:grid-cols-7 [&_.rdp-head_cell]:flex [&_.rdp-head_cell]:items-center [&_.rdp-head_cell]:justify-center [&_.rdp-head_cell]:text-muted-foreground",
        className
      )}
      classNames={{
