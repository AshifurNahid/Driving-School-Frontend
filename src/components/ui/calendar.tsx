        ...
        <div className="flex justify-center items-center gap-2 pt-1">
          ...
          <div className="flex items-center gap-2">
            <select
              ...
              className="text-sm font-medium px-2 py-1 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer"
            >
