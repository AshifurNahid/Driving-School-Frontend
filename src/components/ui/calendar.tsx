  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "grid grid-cols-7 gap-px",
        head_cell:
          "text-muted-foreground rounded-md h-9 w-full flex items-center justify-center font-normal text-[0.8rem]",
        row: "grid grid-cols-7 gap-px w-full mt-2",
      ...
      styles={{
        head_row: { display: "grid", gridTemplateColumns: "repeat(7, minmax(0, 1fr))" },
        row: { display: "grid", gridTemplateColumns: "repeat(7, minmax(0, 1fr))" },
      }}
      components={{
